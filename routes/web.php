...
Route::prefix('user')->withoutMiddleware(VerifyCsrfToken::class)->group(function () {
...
Route::prefix('category')->withoutMiddleware(VerifyCsrfToken::class)->group(function () {
...
Route::prefix('main-category')->withoutMiddleware(VerifyCsrfToken::class)->group(function () {
...
Route::prefix('news')->withoutMiddleware(VerifyCsrfToken::class)->group(function () {
...
Route::prefix('images')->withoutMiddleware(VerifyCsrfToken::class)->group(function () {
